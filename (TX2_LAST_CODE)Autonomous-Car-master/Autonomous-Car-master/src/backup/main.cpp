...
int main(int argc,char** argv)
{
    ...
    while(true)
    {
		try
		{
			...
			isGoStraight = checkGoStraight(pnt[2]);
			if(isGoStraight == 0)//keep going straight
			{
			...
			{
				isCorner = checkCorner(fntPnt, lr); // check is corner
				...
				else if(isCorner == 4) steeringInfo = 29;
				else if(isCorner == 5)
				{
					bool flag = false;
					steeringInfo = -5555;
